...
export const Footer: FC = () => {
  return (
    <div className="flex flex-col w-screen z-20">
      <footer className="border-t-2 border-[#141414] bg-black w-screen py-2 md:py-4">
        <div className="ml-6 mr-6">
          {/* Stack sections vertically on mobile, horizontally on medium/large screens */}
          <div className="flex flex-col space-y-8 md:flex-row md:space-y-0 md:space-x-8 md:justify-end md:items-center">

            {/* Solana Section */}
            <div className="md:flex-1">
              <h5 className="font-normal capitalize mb-2.5">SOLANA</h5>
            ...
            <div className="md:flex-1">
              <h5 className="font-normal capitalize mb-2.5">TOKENS & LIQUIDITY</h5>
              <div className="flex flex-col gap-2">
            ...
            {/* Ecosystem Section */}
            <div className="md:flex-1">
              <h5 className="font-normal capitalize mb-2.5">ECOSYSTEM</h5>
              <div className="flex flex-col gap-2">
            ...
            {/* Support Section */}
            <div className="md:flex-1">
              <h5 className="font-normal capitalize mb-2.5">SUPPORT</h5>
              <div className="flex flex-col gap-2">
                <Link
          ...
          {/* "All rights reserved" and Twitter logo at the bottom */}
